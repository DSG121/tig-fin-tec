...
export default function ProfilePage() {
  const demoUser = {
    ...
    department: "Finance",
    bio: "Experienced financial manager with a background in business analytics and financial planning.",
  };
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          name="full_name"
                          className="pl-10"
                          defaultValue={demoUser.full_name}
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        defaultValue={demoUser.job_title}
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        defaultValue={demoUser.department}
                      />
                    </div>
                  </div>
