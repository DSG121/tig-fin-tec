                      ...
                      >
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-sm text-gray-500">
                            {Math.round(
                              (dept.count / teamMembers.length) * 100,
                            )}
                            %
                          </span>
                        </div>
                  ...
                  <div className="mt-8">
                    ...
                    <div className="space-y-4">
                      {departments.map((dept, index) => {
                        ...
                        const avgWorkload =
                          deptMembers.reduce((sum, m) => sum + m.workload, 0) /
                          deptMembers.length;
                  ...
                  <CardContent className="p-4">
                    ...
                    <div className="mt-4 flex">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <div
                          key={star}
                          className={`w-5 h-5 ${star <= 4 ? "text-yellow-500" : "text-gray-300"}`}
                        >
                          ★
                        </div>
                      ))}
